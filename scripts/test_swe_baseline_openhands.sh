...
harbor run \
    -p /mnt/data1/meta-agent-challenge/swe-meta-agent \
    --agent oracle \
    -m "${TASK_MODEL_NAME}" \
    --n-concurrent 1 \
    --jobs-dir ./test-swe-baseline-openhands \
    --force-build \
    --yes
