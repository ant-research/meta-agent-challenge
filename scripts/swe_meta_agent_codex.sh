#!/bin/bash
# Run SWE Meta-Agent task with Codex agent.
# The meta-agent (codex) runs inside the container, builds/optimizes
...
# Codex needs OpenAI-compatible endpoint
