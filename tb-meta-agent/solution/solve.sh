...
echo "============================================================"
echo "TB Meta-Agent Solution - Mode: $SOLUTION_MODE"
echo "============================================================"
echo ""
...
# Evaluation API URL: defaults to the evaluation-api container, falls back to localhost.
EVAL_API="${EVALUATION_API_URL:-http://localhost:8080}"
